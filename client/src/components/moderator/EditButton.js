  ...
  return (
    <div className='option'>
      <span className='option-edit' onClick={() => setShowPanel(true)}>
        <svg version='1.1' x='0' y='0' viewBox='0 0 16 16' width='16' height='16'>
      ...
      <InputModal show={showPanel} title={props.title} value={props.value} onConfirm={onConfirm} onCancel={() => setShowPanel(false)}>
        {props.content}
      </InputModal>
    </div>
  );
